...
> package under `vendor/`, because Composer does not install a package into its own tree. If it is
> missing, the standard has not been written yet — `CONVENTIONS.md` at the root is what this
